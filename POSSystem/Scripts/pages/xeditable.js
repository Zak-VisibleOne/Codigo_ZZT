...
$(function () {
    ...
    $(".editable-submit").on('click', function (event) {
        alert('edit click');
    });

    // accept on datatable
    //dtTable_filter.on('click', '.accept', function (e) {
    //    e.preventDefault();
    //    var nRow = $(this).parents('tr')[0];
    //    var pos = dtTable_filter.fnGetPosition(nRow);
    //    dtTable_filter.fnAcceptRow(nRow);
    //    _UpdateData(pos);
    //    $('#new_inline').show();
    //});
